export async function sha256Hex(input: string | ArrayBuffer | Uint8Array | Blob): Promise<string> {
...
/**
 * Synchronous SHA-256 (hex). Use this only where an async hash is impractical —
 * e.g. the synchronous redaction pipeline. Prefer the crypto.subtle-based
